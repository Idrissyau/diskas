-- ── Diskas — complete database schema ──────────────────────────────────────
-- Run this on a fresh database. All tables use IF NOT EXISTS so it is safe
-- to re-run; existing data is never dropped.
...
-- Categories (shared by posts, jobs, skills)
